    ...
    , ui(new Ui::MainWindow)
{
    ...
    // Video Setup
    video = new QVideoWidget(ui->page_video);
    video->setGeometry(0, 0, 1920, 1080);
    ...
    QSettings settings("D:/CMS/History/configCMS.ini", QSettings::IniFormat);
...
void MainWindow::downloadFile(int id)       // FUNGSI UNTUK UNDUH FILE DARI DATABASE
{
    ...
    QString downloadDir = "D:/CMS/Downloaded";
...
void MainWindow::playSelectedVideo()        // FUNGSI UNTUK PEMUTARAN VIDEO DARI TABEL (TIDAK DIPAKAI)
{
    ...
    QString videoUrl = "D:/CMS/Downloaded/" + filename;
...
void MainWindow::addLog(const QString &message)     // FUNGSI UNTUK MENAMPILKAN DATA LOG
{
    ...
    QString logFilePath = QString("D:/CMS/History/LogCMS_%1.txt").arg(currentDate);  // Membuat file log berdasarkan tanggal
...
{
    if(firstCall){
        playVideo("D:/CMS/Entertainment/" + entertainment[indexE]);
